...
import { BookOpen, Edit, Trash2, MoreVertical, AlertTriangle } from "lucide-react";
      ...
      <AlertDialogContent className="p-8">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            „<span className="font-medium text-foreground">{book.title}</span>" wird unwiderruflich aus deiner Bibliothek entfernt.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
        ...
        <div className="flex items-center gap-4 rounded-lg border bg-card p-3 transition-colors hover:bg-accent/50 animate-fade-in">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => setConfirmOpen(true)} className="text-destructive"><Trash2 className="mr-2 h-4 w-4" /> Löschen</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
        {deleteDialog}
